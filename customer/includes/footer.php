 <div id="footer"> <!--footer start--->
 	<div class="container">
 		...
 		<p>
 			<strong>www.StrengthSports.com</strong>
 			<br>5, Anand Bhuvan,
 			<br>Anand nagar Road,
 			<br>Opp. Seema Hall,
 			<br>Satellite, Ahmedabad.
 			<br>contact@strengthsports.com
 			<br>+91 99045 33224
        ...
        <hr class="hidden-md hidden-lg">
 			...
 			<h4> Stay In Touch</h4>
 			<p class="social">
 				<a href="https://www.facebook.com/strengthsports.me"><i class="fa fa-facebook"></i></a>
 ...
 <div id="copyright">  <!--cpy right section start-->
 	<div class="container">
 			...
 			<div class="col-md-6">
 				<p class="pull-left">&copy; 2021 Strength Sports Team
