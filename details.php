...
<div class="col-md-9">
  <div class="row" id="productmain">
    ...
    <!----rating---->
    <div class="box">
      <form action="details.php?pro_id=<?php echo $pro_id ?>" method="post" accept-charset="utf-8">
    ...
    <p><label style="font-weight: 20px; font-size: 20px; font-family: "Times New Roman", Times, serif;" for="review">Review</label><textarea class="form-control" name="review" rows="8" cols="40"></textarea></p>
...
$insert_customer_review="insert into customer_rev(rating,review,product_id) values('$rating','$c_review',$pro_id)";
...
<div>
 <!--  <h>Review by saiful</h> -->
     ...
     <?php 
          ...
          $get_rev="select * from customer_rev where product_id=$pro_id";
