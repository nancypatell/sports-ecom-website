...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background: black">
	<div class="navbar-header">
		...
		<a href="index.php?dashboard" class="navbar-brand"> Admin Panel - Strength Sports</a>
	</div>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse ">
		...
		<li style="background-color:#FFF;">
			<a href="index.php?view_customer">
				<i class="fa fa-solid fa-address-book"></i>&nbsp;&nbsp;View Customer
			</a>
		</li>

		<li style="background-color:#FFF;">
			<a href="index.php?view_order">
				<i class="fa fa-thin fa-cart"></i>&nbsp;&nbsp;View Order
			</a>
		</li>
        <li style="background-color:#FFF;">
			<a href="index.php?view_return">
				<i class="fa fa-thin fa-cart"></i>&nbsp;&nbsp;View Return
			</a>
		</li>

		<li style="background-color:#FFF;">
			<a href="index.php?view_payments">
				<i class="fa fa-solid fa-briefcase"></i>&nbsp;&nbsp;View Payments
			</a>
		</li>
