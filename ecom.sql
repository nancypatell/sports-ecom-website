...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 04:27 AM
...
(1, 'Naresh Gupta', 'naresh@strengthsports.com', '123', 'admin.jpg', '9902344222', 'India', 'CEO', 'This is the CEO of the company');
...
(1, 'Sunil Sharma', 'sunil@gmail.com', '123', 'India', 'Ahmedabad', '01758284109', '13, keshavnagar society, subhash bridge,\r\nAhmedabad', 'student-1.jpg', '::1'),
(2, 'Raghav Rao', 'rrao@gmail.com', '56585452', 'India', 'Surat', '01758284109', 'Dharam society, near green gardens, new city road,udhana, surat', 'constantinos-panagopoulos-bAS_PnTzytc-unsplash.jpg', '::1'),
(5, 'Sanjana Singh', 'sanju123@gmail.com', '123', 'India', 'Surat', '01665465454', ' Ratna appartments, near shivji temple, cotton market, surat', 'student-5.jpg', '::1'),
(7, 'Shyam Dave', 'shhyaamd@gmail.com', '123', 'India', 'Surat', '01758284109', 'Dhupkhola society, ramannagar,surat', 'saiful1.jpg', '::1'),
(8, 'Sanjay Joshi', 's2598@gmail.com', '56585452', 'India', 'Surat', '01758284109', 'Skyline heights, opp. mega mall, udhana, suart', 'saiful1.jpg', '::1'),
(9, 'Mangesh', 'mangesh@gmail.com', '123', 'India', 'Surat', '01758284109', 'Sanvi society, near new hanuman mandir, camp road, surat', 'me 1.1.jpg', '::1'),
(10, 'Ashish', 'ash@gmail.com', '123', 'India', 'Surat', '01758284109', 'Dinbandhu society, bhatar char rasta, surat', 'as.jpg', '::1'),
(11, 'AKASH', 'AKASH@gmail.com', '123', 'India', 'Surat', '01758284109', 'Dhupkhola math , Gendaria , Dhaka., Jagannath University, Dhaka', 'saiful1.jpg', '::1'),
(12, 'AKASH', 'a@gmail.com', '123', 'India', 'Surat', '01758284109', 'Dhupkhola math , Gendaria , Dhaka., Jagannath University, Dhaka', 'Screenshot (1).png', '::1'),
(13, 'mahesh', 'mahesh@hotmail.com', 'genius123@', 'india', 'ahmedabad', '9904534334', 'adfa asdfsaf', 'IMG20211027084407.jpg', '::1');
...
(33, 1, 6, 2500, '', 1310614455, 1, 'Small', '2022-04-04 18:42:37', 'Return'),
...
(44, 13, 1, 1000, '', 1685680797, 1, 'Small', '2022-03-19 04:00:36', 'pending'),
(45, 13, 6, 5000, '', 1685680797, 2, 'Large', '2022-03-19 04:00:36', 'pending'),
(46, 5, 6, 7500, '', 2015624368, 3, 'Small', '2022-04-03 02:28:16', 'pending'),
(47, 5, 1, 5000, '', 2015624368, 5, 'Large', '2022-04-03 02:28:16', 'pending'),
(48, 5, 2, 40000, '', 2015624368, 2, 'Medium', '2022-04-03 02:28:16', 'pending'),
(49, 13, 5, 450000, '', 1694010537, 3, 'Small', '2022-04-03 14:49:37', 'pending'),
(50, 13, 4, 14000, '', 1694010537, 4, 'Extra Large', '2022-04-03 14:49:37', 'pending');
...
INSERT INTO `customer_rev` (`rev_id`, `rating`, `review`, `product_id`) VALUES
(9, 1, 'This is the  worse product ever', 1),
(10, 1, 'This is the  worse product ever', 2),
(13, 5, 'aa asdfasdfasdf', 1),
(14, 5, 'Hello my review', 3),
(15, 3, 'Hello your review', 4),
(16, 3, 'Hello your review', 5),
(17, 4, 'hello my review', 6),
(18, 4, 'hello my review', 2),
(21, 4, 'hello my review', 2);
...
(4, 'My name is Jayesh Shukla', '2020-04-22 12:41:22', 'bot'),
(5, 'Where are your from', '2020-04-22 12:41:30', 'user'),
(6, 'I m from Ahmedabad, India', '2020-04-22 12:41:30', 'bot'),
...
(18, 'Mr. Nalini Shah is the CEO.', '2020-10-26 04:22:10', 'bot'),
...
(31, 'sfgsdg', '2022-04-04 07:58:50', 'user'),
(32, 'Sorry not be able to understand you', '2022-04-04 07:58:50', 'bot');
...
INSERT INTO `order_return` (`return_id`, `order_id`, `return_date`, `amount_return`, `customer_email`, `payment_mode`) VALUES
(1, 33, '2022-04-04 18:46:55', 2500, 'sunil@gmail.com', 'Bank transfer');
...
(20, 456444, 2500, 'Bank transfer', 43534534, '2022-04-03');
...
(1, 2, 4, '2022-04-03 14:23:12', 'Cricket Helmet', 'grant-ritchie-n_wXNttWVGs-unsplash.jpg', 'grant-ritchie-n_wXNttWVGs-unsplash.jpg', 'grant-ritchie-n_wXNttWVGs-unsplash.jpg', 1000, '<p>demo.......................................</p>', 'q3xl2k32sd3323sd'),
(2, 4, 4, '2022-04-04 02:07:25', 'Cricket Bat', 'daniel-korpai-GFrn9Wxqfjo-unsplash.jpg', 'jeroen-den-otter-iKmm0okt6Q4-unsplash.jpg', 'leon-seibert-EOw_TbrWW_c-unsplash.jpg', 20000, '<p>It is really a good product for those who want to capture the best picture</p>', 'q3xl-2k32-sd33-23sd'),
(3, 4, 1, '2022-04-04 02:08:50', 'Badminton Racket', 'paul.png', 'paul.png', 'paul.png', 1300, '<p>nice</p>', 'q3xl-2k32-sd33-23sd'),
(4, 5, 1, '2022-04-04 02:08:22', 'Sports Blue T-Shirt', 'ana-maria-nichita-hp7Uj0EO__g-unsplash.jpg', 'ana-maria-nichita-hp7Uj0EO__g-unsplash.jpg', 'ana-maria-nichita-hp7Uj0EO__g-unsplash.jpg', 3500, '<p>nice</p>', 'q3xl2k32sd3323sd'),
(5, 3, 4, '2022-04-04 02:07:56', 'Sports Shoes', 'markus-spiske-s7nlaF3kefg-unsplash.jpg', 'markus-spiske-s7nlaF3kefg-unsplash.jpg', 'markus-spiske-s7nlaF3kefg-unsplash.jpg', 150000, '<p>Black Shoes</p>', 'dfsfdf sdfhf sdffkj sdfhj'),
(6, 4, 1, '2022-04-04 02:07:01', 'Cricket Ball', 'bass-guitar.jpg', 'bass-guitar.jpg', 'bass-guitar.jpg', 2500, 'THIS IS THE BEST GUITAR EVER', 'q3xl-2k32-sd33-23sd');
...
(4, 'SPORTS EQUIPMENT', 'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero\'s De Finibus Bonorum et Malorum for use in a type specimen book'),
...
INSERT INTO `reviews` (`id`, `page_id`, `name`, `content`, `rating`, `product_id`, `submit_date`) VALUES
(1, 1, 'David Deacon', 'I use this website daily, the amount of content is brilliant.', 5, 3, '2020-01-09 20:43:02'),
(2, 1, 'John Doe', 'Great website, great content, and great support!', 4, 6, '2020-01-09 21:00:41'),
(3, 1, 'Robert Billings', 'Website needs more content, good website but content is lacking.', 3, 1, '2020-01-09 21:10:16'),
(4, 1, 'Daniel Callaghan', 'Great!', 5, 2, '2020-01-09 23:51:05'),
(5, 1, 'Bobby', 'Not much content.', 2, 4, '2020-01-14 21:54:24'),
(6, 1, 'Joshua Kennedy', 'Fantasic website, has everything I need to know.', 5, 3, '2020-01-16 17:34:27'),
(7, 1, 'Johannes Hansen', 'Really like this website, helps me out a lot!', 5, 3, '2020-01-16 17:35:12'),
(8, 1, 'Wit Kwiatkowski', 'Please provide more quality content.', 5, 5, '2020-01-16 17:36:03'),
(9, 1, 'Óli Þórðarson', 'Thanks', 5, 6, '2020-01-16 17:36:34'),
(10, 1, 'Jaroslava Beránková', '', 5, 5, '2020-01-16 17:37:48'),
(11, 1, 'Naomi Holt', 'Appreciate the amount of content you guys do.', 5, 3, '2020-01-16 17:39:17'),
(12, 1, 'Isobel Whitehead', 'Thank you for providing a website that helps us out a lot!', 5, 1, '2020-01-16 17:40:28'),
(13, 1, 'Warren Mills', 'Everything is awesome!', 5, 2, '2020-01-16 19:34:08'),
(14, 1, 'Larry Johnson', 'Brilliant, thank you for providing quality content!', 5, 6, '2020-01-29 18:40:36');
...
(0, 'Chetan Pujara', '5, jaykrushna society, Vadaj, ahmedabad', 'Ahmedabad', '8978977773'),
(1, 'Naresh Patel', '7, narendra society, Nadiad', 'Nadiad', '8989567667'),
(15, 'Umesh patel', '27, Balakrushna Society, Opp. Seema Hall,\r\nSatellite, Ahmedabad', 'Ahmedabad', '9089089888'),
(17, 'Mitesh shah', '6, Ferin Complex, Goddhod road, Surat', 'Surat', '8978747775'),
(18, 'Virendra Jani', '88, ganesh society, ganesh pura, vadodara', 'Vadodara', '9089087786'),
(19, 'Pritesh Jani', '77, chetna society,\r\nbhimjipura, vadaj', 'Ahmedabad', '9808908888'),
(20, 'Ganesh Doda', '65, Marutinandan Society,\r\nPaldi, Ahmedabad', 'Ahmedabad', '9089866654');
...
--
ALTER TABLE `customer_rev`
  MODIFY `rev_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
